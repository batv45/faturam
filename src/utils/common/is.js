...
/**
 * * Similar to mysql's IF NULL function
 * * If the first parameter is null/undefined/'', the second parameter is returned as a backup value, otherwise the first parameter is returned.
